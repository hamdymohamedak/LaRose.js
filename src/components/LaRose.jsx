...
export function ModernBtn({ title, allColor, children, fontSize, color, hoverColor, clickEvent, h = "4", w = "11" }) {
...
export default function RoseBox({ children, edit = {}, background = "", RoseName = "", RoseID = "", autoLayout = false, shadow = false, aspectRatio = null, atHover = false, grid = false, flex = false, clickEvent }) {
